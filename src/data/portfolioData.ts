...
export const projects: Project[] = [
  {
    ...
    outcomes: [
      ...
      'Submitted to Anthropic MCP 1st Birthday Hackathon — MCP in Action Consumer Track'
    ],
    visuals: [
      {
    ...
    gameDetails: {
      ...
      skillsUnlocked: [
        ...
        "🏆 Hackathon Submission - Built and submitted to Anthropic's MCP 1st Birthday Hackathon"
      ],
      bossFights: [
  ...
  },
  {
    ...
    outcomes: [
      ...
      'Presented as poster at SRC2026 (June 17–18, 2026) and under review at IEEE Journal of Biomedical and Health Informatics (JBHI)',
    ...
    gameDetails: {
      questOverview: '🔬 Research Quest: Designed a modular U-Net framework with 8 YAML-controlled ablation configs, unifying 2D/3D medical segmentation across 5 datasets. 82% smaller than baselines. Presented at SRC2026 and under review at IEEE JBHI.',
      skillsUnlocked: [
      ...
      bonusLevel: '🏆 SRC2026 Poster + JBHI Under Review: Research-grade framework supervised by Dr. Armagan Elibol & Dr. Nuha Hamada — presented at SRC2026 (June 2026) and now under review at IEEE JBHI.',
    },
  },
  {
    id: 'tomato-care',
    ...
    image: '/assets/images/tomato-care/cover.svg',
  ...
  },
  {
    ...
    image: '/assets/images/defect-detection/cover.svg',
    featured: false,
  ...
  },
  {
    ...
    description: 'Supported a model bake-off at Cellula Technologies evaluating retail action recognition models (VideoMAE, MoViNet, TimeSformer, YOLO+LRCN) for a real-time security system — contributing to data preparation and pipeline testing. MVC architecture: FastAPI controller, Streamlit dashboard, PostgreSQL incident logging, Docker deployment.',
    category: 'ai-cv',
    skills: ['VideoMAE', 'MoViNet', 'TimeSformer', 'YOLOv8', 'FastAPI', 'Streamlit', 'PostgreSQL', 'Docker', 'Python'],
    image: '/assets/images/shoplifting-detection/cover.svg',
    featured: false,
    detailedDescription: 'A real-time shoplifting detection system built during internship at Cellula Technologies. The team ran a model bake-off comparing several SOTA video understanding approaches (VideoMAE, MoViNet, TimeSformer, YOLO+LRCN, X3D/I3D) to find the best speed/accuracy tradeoff for edge retail deployment; my contribution centered on data preparation and pipeline testing across the candidate models. Architecture follows MVC: a sliding-window FastAPI controller feeds 24-frame buffers to the selected model, triggers PostgreSQL incident logging on detection, and surfaces everything through a real-time Streamlit dashboard. Containerized with Docker for reproducible deployment.',
    challenges: [
      'Preparing and cleaning training data consistently across 5 different model implementations',
    ...
    solutions: [
      'Followed strict MVC separation: each member owns one directory (models/, views/, controllers/) with a shared interface',
    ...
    outcomes: [
      ...
      'Hands-on experience across the full bake-off — data preparation, pipeline testing, and evaluation of candidate models',
    ],
    techStack: {
      ...
      other: ['MVC Architecture', 'Team Collaboration (5 members)', 'Git Workflow Design'],
    },
    gameDetails: {
      questOverview: '🛡️ Security AI Quest: Contributed to a 7-model bake-off building a real-time shoplifting detection system — from VideoMAE research to Streamlit dashboard to PostgreSQL incident logs — focused on data preparation and pipeline testing.',
      skillsUnlocked: [
        '🧪 Data Preparation & Pipeline Testing — supported a multi-model bake-off across parallel tracks',
      ...
      bonusLevel: '🏆 Team Contribution: Hands-on experience supporting a multi-engineer bake-off from data preparation through pipeline testing — MVC structure, Docker containerization, and shared interface design.',
    },
  },
  {
    id: 'minecraft-cv',
    ...
    image: '/assets/images/minecraft-cv/cover.svg',
  ...
  {
    id: 'water-body-segmentation',
    title: 'Satellite Water Body Segmentation',
    description: 'Semantic segmentation pipeline using Sentinel-2 multi-spectral satellite imagery to predict flood-prone and water-covered areas. A Mix Transformer (MiT-B2) backbone achieved a 0.854 IoU, beating a U-Net baseline, and was deployed as a Flask app with sub-1s inference on uploaded TIFF files.',
    category: 'ai-cv',
    skills: ['PyTorch', 'MiT-B2', 'Segmentation Models PyTorch (SMP)', 'Sentinel-2', 'Rasterio', 'Flask', 'Remote Sensing', 'Semantic Segmentation'],
    image: '/assets/images/water-body-segmentation/cover.svg',
    github: 'https://github.com/AlBaraa63/Water-Body-Segmentation',
    featured: false,
    detailedDescription: 'A remote-sensing semantic segmentation pipeline that predicts flood-prone and water-covered areas from Sentinel-2 multi-spectral satellite imagery. The project compares a standard U-Net against pretrained Transformer backbones using Segmentation Models PyTorch (SMP), with the Mix Transformer (MiT-B2) architecture delivering the best performance. Raw Sentinel-2 tiles carry sensor NaN values and 12 spectral bands, so the pipeline includes a dedicated preprocessing stage before training. The final model is served through a Flask web app that runs inference on uploaded GeoTIFF files in under one second.',
    challenges: [
      'Raw Sentinel-2 sensor data contains NaN values caused by out-of-bounds flag values, corrupting training',
      'Pretrained CNN/Transformer backbones expect 3-channel RGB input, but Sentinel-2 imagery has 12 spectral bands',
      'Selecting the best speed/accuracy backbone for water-body segmentation across multiple architectures',
    ],
    solutions: [
      'Designed a median-imputation preprocessing module to resolve raw Sentinel-2 NaN sensor values',
      'Adapted 3-channel pretrained backbones to 12-band imagery via a 1x1 conv pre-layer projection (with a replace-layer strategy)',
      'Benchmarked a U-Net baseline against pretrained Transformer backbones, selecting MiT-B2 as the top performer',
    ],
    outcomes: [
      'MiT-B2 backbone achieved a 0.854 IoU score, outperforming the U-Net baseline',
      'Deployed as a Flask app with sub-1 second inference on uploaded TIFF files',
      'End-to-end pipeline handling 12-band Sentinel-2 imagery from preprocessing to prediction',
    ],
    techStack: {
      ai: ['PyTorch', 'Mix Transformer (MiT-B2)', 'Segmentation Models PyTorch (SMP)', 'Semantic Segmentation'],
      backend: ['Python', 'Flask', 'Rasterio', 'NumPy'],
      other: ['Sentinel-2 Multi-Spectral Data', 'GeoTIFF Processing', 'Median Imputation', '12-Band Input Adaptation'],
    },
    gameDetails: {
      questOverview: '🛰️ Remote Sensing Quest Complete! Built a satellite water-body segmentation pipeline on Sentinel-2 imagery, adapting pretrained backbones to 12-band data and hitting a 0.854 IoU with MiT-B2 — deployed as a sub-1s Flask app.',
      skillsUnlocked: [
        '🛰️ Multi-Spectral Remote Sensing — Sentinel-2 12-band imagery processing with Rasterio',
        '🧠 Transformer Segmentation — MiT-B2 backbone via Segmentation Models PyTorch (SMP)',
        '🩹 Sensor Noise Handling — median imputation for out-of-bounds NaN sensor values',
        '🔀 Band Adaptation — 1x1 conv pre-layer projection to fit 3-channel backbones to 12 bands',
        '🌐 Flask Deployment — sub-1s inference on uploaded GeoTIFF files',
      ],
      bossFights: [
        '🩹 The NaN Sensor Phantom — corrupted Sentinel-2 values defeated with median imputation',
        '🔀 The Band Mismatch Dragon — bridging 3-channel backbones to 12-band spectral imagery',
        '⚖️ The Backbone Bake-off — U-Net vs Transformer backbones for the best IoU',
      ],
      bonusLevel: '🏆 Geospatial Impact: A deployable flood-mapping tool that turns raw Sentinel-2 tiles into water-body masks in under a second — 0.854 IoU beating the U-Net baseline.',
    },
  },
  {
    id: 'autotarget',
    title: 'AutoTarget — Autonomous Robotic Control System',
    description: 'Built for the IEEE Student Day Challenge (AY 2025–2026): a Raspberry Pi vision system that steers a robotic plane to intercept and redirect incoming tennis balls into target zones. Combines HSV tracking, lens calibration, homography mapping, and Kalman trajectory prediction with a sub-100 ms PySerial link to an Arduino servo controller.',
    category: 'robotics',
    skills: ['Raspberry Pi', 'Python', 'OpenCV', 'PySerial', 'Arduino', 'C++', 'Kalman Filters', 'Robotics'],
    image: '/assets/images/autotarget/cover.svg',
    featured: false,
    detailedDescription: 'AutoTarget is an autonomous robotic control system built for the IEEE Student Day Challenge (AY 2025–2026). A Raspberry Pi runs a real-time computer vision pipeline that tracks incoming tennis balls and steers a robotic plane to intercept and redirect them into target zones. Ball tracking combines HSV color filtering, camera lens calibration, and homography coordinate mapping, paired with Kalman filtering to predict ball trajectories in 3D space. The computed plane bisector angles are transmitted to an Arduino servo-controller over a custom PySerial interface achieving sub-100 ms glass-to-glass latency. (Vibe-coded baseline implementation.)',
    challenges: [
      'Tracking a fast-moving tennis ball in real time and predicting where it will be in 3D space',
      'Mapping 2D camera pixel coordinates to real-world positions despite lens distortion',
      'Minimizing end-to-end latency from camera capture to physical servo actuation',
    ],
    solutions: [
      'Combined HSV color filtering, camera lens calibration, and homography coordinate mapping for accurate ball localization',
      'Applied Kalman filtering to predict ball trajectories in 3D space ahead of interception',
      'Wrote a custom PySerial communication interface to an Arduino servo-controller achieving sub-100 ms glass-to-glass latency',
    ],
    outcomes: [
      'Real-time ball tracking and trajectory prediction driving autonomous plane steering',
      'Sub-100 ms glass-to-glass latency from camera capture to servo actuation',
      'End-to-end embedded pipeline: Raspberry Pi vision → Kalman prediction → Arduino actuation',
    ],
    techStack: {
      ai: ['OpenCV', 'HSV Color Filtering', 'Kalman Filters', 'Homography Mapping'],
      backend: ['Python', 'PySerial', 'NumPy', 'Vector Mathematics'],
      other: ['Raspberry Pi', 'Arduino (C++)', 'Camera Lens Calibration', 'Servo Control'],
    },
    gameDetails: {
      questOverview: '🤖 Robotics Quest: Built an autonomous targeting system for the IEEE Student Day Challenge — a Raspberry Pi tracks incoming tennis balls with HSV vision and Kalman prediction, then steers a robotic plane to redirect them via a sub-100 ms Arduino link.',
      skillsUnlocked: [
        '🎯 Real-Time Ball Tracking — HSV filtering + lens calibration + homography mapping',
        '📈 Kalman Trajectory Prediction — forecasting ball paths in 3D space',
        '📡 Low-Latency Serial Control — custom PySerial link to Arduino servo controller',
        '🔧 Embedded Vision — Raspberry Pi camera pipeline to physical actuation',
      ],
      bossFights: [
        '⚡ The Latency Hydra — sub-100 ms glass-to-glass from camera to servo',
        '🎯 The Moving Target — predicting a fast tennis ball\'s 3D trajectory in real time',
        '📐 The Calibration Dragon — mapping pixels to real-world coordinates through lens distortion',
      ],
      bonusLevel: '🏆 IEEE Student Day Challenge (AY 2025–2026): A full embedded vision-to-actuation loop — Raspberry Pi tracking, Kalman prediction, and Arduino servo control working in concert.',
    },
  }
];
...
export const certifications: Certification[] = [
  ...
  },
  {
    ...
    icon: '🧠',
    link: 'https://cs50.harvard.edu/certificates/2f3480b5-0018-41df-92a2-b87b3924ebb0',
    featured: true,
    status: 'completed'
  },
  {
    id: 'intro-cv-image-processing',
    title: 'Introduction to Computer Vision and Image Processing',
    issuer: 'IBM / edX',
    date: '2024',
    description: 'Fundamentals of computer vision and digital image processing techniques',
    icon: '👁️',
    link: '#'
  },
  {
...
export const experience: Experience[] = [
  {
    id: 'adssa-ai-ds-intern',
    title: 'AI & Data Science Intern',
    company: 'Abu Dhabi Social Support Authority',
    type: 'work',
    period: 'Jun 2026 - Present',
    current: true,
    description: 'Part of the AI & Data Science team supporting data-driven decision-making for social support programs.',
    highlights: [
      'Ran a causal inference and uplift-modeling literature review that guided the team\'s analytical approach',
      'Ran daily QA of large-scale survey data — backups, checklist-based interview review, and anomaly detection via unsupervised clustering',
      'Built a local web QA tool over ~10 iterations: digital checklist, searchable interview log, Excel import/export, statistics dashboard, automated daily-summary email drafts, and Cohen\'s κ inter-rater reliability',
      'Built an end-to-end ML pipeline for a beneficiary outcomes program — supervised classification with cross-validation, SHAP feature attribution, unsupervised segmentation, and an interpretable decision-tree tool for case workers — fully reproducible with automated tests and numeric traceability',
    ],
    skills: ['Python', 'Data QA', 'SHAP', 'Causal Inference', 'Supervised & Unsupervised Learning', 'Reproducible ML'],
  },
  {
    ...
    current: false,
    description: 'Completed the intensive, month-long C programming and Unix software engineering selection program at 42 Abu Dhabi — one of the global 42 Network campuses.',
    highlights: [
      'Completed the month-long program covering loops, pointers, dynamic memory allocation (malloc), algorithms, shell scripting, and Git through project-based peer learning',
      'Passed the final exam under time pressure with a score of 66%, demonstrating independent debugging capabilities',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'Co-designed F-UNet, a parameter-efficient medical segmentation framework — 82% parameter reduction (5.39M params) outperforming baselines across 5 datasets',
      'Presented F-UNet as a poster at SRC\'26 (June 17–18, 2026); manuscript currently under review at IEEE JBHI (submitted Feb 28, 2026)',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'Developed a semantic segmentation pipeline on Sentinel-2 satellite imagery to predict flood-prone and water-covered areas — 0.854 IoU',
      'Supported the evaluation of retail action recognition models (MoViNet, VideoMAE, TimeSformer), contributing to team data preparation and pipeline testing',
    ],
    skills: ['PyTorch', 'OpenCV', 'YOLOv8', 'Deep Learning', 'Python', 'Streamlit'],
  },
  {
    id: 'samsung-innovation',
...
export const research: Research[] = [
  ...
  {
    id: 'jbhi-funet',
    title: 'F-UNet: A Modular Encoder-Decoder Framework for Parameter-Efficient Medical Image Segmentation in the Era of Foundation Models',
    abstract: 'Presents a modular, parameter-efficient encoder-decoder medical segmentation framework (F-UNet) that unifies 2D and 3D medical image segmentation pipelines. By utilizing Residual Involution and Squeeze-and-Excitation (SE) attention, the framework enables combinations of diverse encoders, dense bottlenecks, and attention-gated skip connections. Evaluated across five medical imaging domains (Chest X-Ray, BUSI, GlaS, CVC-ClinicDB, and 3D CT), the architecture achieves an 82% model size reduction (5.39M parameters) compared to conventional U-Net baselines while outperforming standard baselines.',
    year: '2026',
    conference: 'IEEE Journal of Biomedical and Health Informatics (JBHI) — Under Review (submitted Feb 2026)',
  },
  {
    id: 'src2026-funet',
    ...
    year: '2026',
    conference: 'SRC2026 — 17th Student Research Conference on Applied Computing (Poster — presented June 17–18, 2026)',
  },
];
...
export const resumeConfig = {
  ...
  // Self-hosted — served directly from /public
  get previewUrl() {
    return '/resume.pdf';
  },
  get downloadUrl() {
