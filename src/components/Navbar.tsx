            ...
            <div className="flex items-baseline space-x-1 lg:space-x-2">
              {navItems.map((item, index) => (
                <button
                  ...
                  className={`group relative px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 transform-gpu active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${
        ...
        <div className="relative z-10 px-2 pt-2 pb-3 space-y-1 sm:px-3">
          {navItems.map((item, index) => (
            <button
              ...
              className={`group block w-full px-4 py-3 rounded-lg text-base font-medium text-left transition-all duration-500 hover:scale-105 active:scale-95 transform-gpu focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${
                activeSection === item.id ? 'mobile-active' : 'mobile-inactive'
              }`}
              style={{
                color: activeSection === item.id ? 'var(--accent)' : 'var(--text-primary)',
                background: activeSection === item.id 
